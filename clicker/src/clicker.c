...
/**
 * @brief Dessine un bouton centré et détecte un clic.
 * @param[in] font Police utilisée
 * @param[in] text Texte du bouton
 * @param[in] centerX Position X centrale
 * @param[in] y Position Y
 * @param[in] fontSize Taille de la police
 * @param[in] baseColor Couleur de base
 ...
 * @param[in] font Police utilisée
 * @param[in] name Nom du bâtiment
 * @param[in,out] count Nombre actuel de bâtiments
 * @param[in] baseCost Coût de base
 * @param[in] scale Facteur d'augmentation du coût
 * @param[in,out] res Ressource utilisée pour l'achat
