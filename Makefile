...
WIN_CFLAGS = -Wall -Wextra -std=c99 -Iraylib_win/include -Iclicker/inc -Icombat/inc -Icore/inc -Idungeon/inc -Iscenes/inc -Iui/inc -Iutils/inc
WIN_LDFLAGS = -Lraylib_win/lib -lraylib -lopengl32 -lgdi32 -lwinmm -static -mwindows
WIN_SRC = clicker/src/*.c combat/src/*.c core/src/*.c dungeon/src/*.c scenes/src/*.c ui/src/*.c utils/src/*.c
